  ...
  return (
    <Fragment>
      <main className="flex flex-col justify-center items-center  mb-6">
        <h1 className="font-extrabold text-4xl pt-2 mb-4 lg:text-4xl md:pt-9 lg:mb-5">
          Campeonato Ranking G1 Feria de las Flores 2022
        </h1>
        <div className="w-3/5 mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 pt-6 gap-4">
