      ...
      <Page size="A4">
        ...
        <View style={styles.tabla}>
          <View style={styles.tablaFila}>
            ...
            <View style={styles.tablaColumna1}>
              <Text style={styles.tablaCeldaHeader}>DELEGACION BRONCE 1</Text>
            </View>
          </View>
          ...
          {bronce.map((data) => (
            <View style={styles.tablaFila} key={data.COD}>
              ...
              <View style={styles.anchoColumna}>
                <Text style={styles.tablaCeldaContents}>{data.Bronce1}</Text>
              </View>
              <View style={styles.anchoColumna}>
                <Text style={styles.tablaCeldaContents}>
                  {data.delacion_bronce1}
                </Text>
              </View>
            </View>
          ))}
